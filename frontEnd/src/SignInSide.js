...
const useStyles = makeStyles(theme => ({
    ...
    image: {
        backgroundImage: 'url(https://legitpost.co.za/wp-content/uploads/2019/10/call-centre-26.jpg)',
                ...
                <Grid container component="main" className={classes.root}>
                    ...
                    <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                        ...
                        <div>
                            ...
                            >
                                <DialogTitle id="alert-dialog-title">{"Login to Students feeding app"}</DialogTitle>
                                <DialogContent>
