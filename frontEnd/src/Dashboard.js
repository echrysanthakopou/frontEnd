...
import UpdateCommunicationDetails from './UpdateCommunicationDetails';

import PostsCreate from "./createNewAppl";
                    ...
                    <Container maxWidth="lg" className={classes.container}>
                        ...
                        <card>
                            <Switch>
                                ...
                                <Route path='/listIssues' render={(props) => <UpdateCommunicationDetails {...pros}
                                                                                                         isAuthed={true}/>}/> //component={PostsCreate}/>
                                <Route path='/home' render={(props) => <UpdateCommunicationDetails {...pros}
                                                                                                   isAuthed={true}/>}/> //component={PostsCreate}/>
                                ...
                                <Route path='/' render={(props) => <UpdateCommunicationDetails {...pros}
                                                                                               isAuthed={true}/>}/> //component={PostsCreate}/>
